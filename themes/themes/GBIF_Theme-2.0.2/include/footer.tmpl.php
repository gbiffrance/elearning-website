...
<div id="footer">
	...
	<ul class="social_icons">
		<li>
			<a title="Rejoignez sous sur Twitter !" href="http://twitter.com/gbiffrance" target="_blank"><img alt="twitter logo" src="<?php echo $this->base_path; ?>themes/GBIF_Theme-2.0.2/images/Logo-Twitter-white.png" width="28" height="28" /></a>
		</li>
		<li>
			<a href="https://www.facebook.com/gbifnews" title="Page Facebook du GBIF" target="_blank"><img alt="" src="<?php echo $this->base_path; ?>themes/GBIF_Theme-2.0.2/images/Logo-Facebook.png"   width="28" height="28"  /></a> 
		</li>
	</ul>
	<p><span class="adresse-footer">GBIF FRANCE</span> - <span class="adresse-footer">MNHN Geologie</span> - <span class="adresse-footer">43 rue Buffon CP 48</span> . <span class="adresse-footer">75005 Paris</span>  .  <span class="adresse-footer">France . Tel : +33 (0)1 40 79 80 65</span></p>
	<hr/>
